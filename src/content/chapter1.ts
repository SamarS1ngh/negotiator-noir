...
export const CHAPTER_1: Chapter = {
  ...
  actions: [
    ...
    },
    {
      ...
      label: 'Turn the crew against him',
      blurb: "Loyalty on the docks is thin, and it follows whoever's winning.",
      grants: ['crewSpooked'],
      result: '',
      scene: [
    ...
    },
    {
      ...
      label: 'Get the shipping manifests',
      blurb: 'A loader can get you a month of numbers — for the right reason.',
      grants: ['ledger'],
      requires: [],
      result: '',
      scene: [
      ...
      ask: "Enough money to make a swim in the harbor worth the risk.",
      options: [
        { text: "Pay him well, and cover the risk", good: true,
          result: "“Forty in, thirty-three on paper. Every week.” The ledger's yours.",
          ripple: "A loader's been asking questions. Ricci's people start watching the paperwork." },
        { text: "Appeal to doing what's right", good: false,
          result: "“Right? I've got kids to feed. Get out of here.” Nothing.",
          failDelta: { nodeId: 'crew', delta: -1 } },
        { text: "Threaten to turn him in", good: false,
          result: "He shuts the door in your face. You'll get nothing on the docks now.",
          failDelta: { nodeId: 'crew', delta: -1 } },
      ],
    },
    {
